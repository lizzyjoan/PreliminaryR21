...
params <- setParam(params, "nPatterns", 11)
...
```
```{r}
#to look ath highest weighted genes, going to select genes with highest averages across patterns
...
```{r}
ggplot(mouse_featloadings_long, mapping = aes(x = pattern, y = genes, fill = feat_weight)) + geom_tile() 
```
