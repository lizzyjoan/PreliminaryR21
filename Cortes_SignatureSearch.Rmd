...
```{r}
ggsave(filename = "210629_lincs_pert_plot.pdf", lincs_prelim_plot)
```
...
top_pathways <- comp_fea_res(table_list, rank_stat = "pvalue", Nshow = 20) + 
  labs(x = "Gene Expression Signature Search Method", y = "KEGG Pathways") +
  labs(title = "Top Exercise Signature Pathways") +
...
```{r}
ggsave(filename = "210629_SignatureSearch_TopPathways.pdf", top_pathways)
```
